      ...
      <div>
        ...
        <Row>          
          <Col sm={{ size: '6' }}>
            ...
            <Button color="link" onClick={this.props.reset}>Skift adresse</Button>
          </Col>
          <Col sm={{ size: '6' }}>          
          <p>Nedenfor kan du få et indtryk af, hvor udsat din bolig er ved oversvømmelse efter skybrud. Når du har oplyst, hvad du selv har gjort for at undgå oversvømmelser, får du en række anbefalinger til nye tiltag.</p>

          <p>Vær opmærksom på, at din risiko er baseret på offentligt tilgængelige data, som kan være behæftet med usikkerheder. Læs mere her.</p>
          </Col>
        </Row>
        </div>
     </div>
