    ...
    if (this.state.isLoading) {
      ...
      return (
        <div className="water-comes-app-address">
          ...
          <p>Tast din adresse og få indblik i, hvad der kan påvirke din boligs risiko for oversvømmelse ved skybrud eller stormflod. Du får også konkrete råd til, hvad du kan gøre for at sikre din bolig.</p>

          <p>Vær opmærksom på, at resultatet er baseret på offentligt tilgængelige data, som kan være behæftet med usikkerheder. <button className="btn btn-link">Læs mere om datagrundlaget her.</button></p>
          ...
          <p className="small">Risikoberegneren egner sig ikke til lejligheder. Vi gemmer ikke din adresse. Læs vores <a href="https://www.bolius.dk/cookiepolitik-og-retningslinjer-paa-bolius-platforme">cookiepolitik og øvrige retningslinjer</a>.</p>
        </div>
      );
    }
  }
