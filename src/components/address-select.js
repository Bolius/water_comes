...
import adressevaelgerModule from "./adressevaelger.module";
...
export default function AdressSelect(props) {
    ...
    useEffect(() => {
        if (!isLoading) {
            ...
            if (!document.getElementById("dawa-autocomplete-input").classList.contains('loaded')) {

                adressevaelgerModule().adressevaelger(document.getElementById("dawa-autocomplete-input"), {
                    token: "adressevaelger123",
                    select: function (selected) {
                        handle_dawa_resp(selected.adresse.id_lokalid);
                    },
                });
                document.getElementById("dawa-autocomplete-input").classList.add('loaded');
            }
        }
    ...
    return isLoading ? (
        ...
        <div className="water-comes-app-address">
            ...
            <link rel="stylesheet"
                  href="https://www.bolius.dk/typo3conf/ext/bolius_embedded/Resources/Public/Adressevaelger/adressevaelger.css"></link>
